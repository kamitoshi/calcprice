...
<head>
   ...
   * {margin:0; padding:0; box-sizing:border-box;}
   ...
   .sidebar{background-color:#333; color:#fff; height:100vh; width:300px; position:fixed;}
   .sidebar a{color:#fff; text-decoration:none; }
   .main_container{margin-left:300px; padding:30px 50px; width:100%;}
   .content {margin:10px; }
   .flex{display:flex;}
   .flex_child {flex:1;}
   ...
   <link rel="stylesheet" type="text/css" href="{{asset('css/original.css')}}">
</head>
<body>
    <header>
